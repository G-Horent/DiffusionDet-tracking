...
DatasetCatalog.register("MOT17_train", get_MOT17_train)
MetadataCatalog.get("MOT17_train").thing_classes = MOT_CLASS_NAMES
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        #DatasetCatalog.register("MOT17_test", get_MOT17_test)
        mapper = DiffusionDetDatasetMapper(cfg, is_train=True)
        return build_detection_train_loader(cfg, mapper=mapper, total_batch_size=1)
